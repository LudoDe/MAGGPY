...
def run_populations(alphas, fj_bns_values, geom_eff_func, datafiles, 
    ...
    for alpha in alphas:
        ...
        for fj_bns in fj_bns_values:
            ...
            # STAGE 1: BNS ONLY
            # =========================================================
            run_name_stage1 = f'universal_stage1_bns_only_alpha_{alpha}_fj{fj_bns:.1f}'
            ...
            # STAGE 2: BNS + NSBH
            # =========================================================
            run_name_stage2 = f'universal_stage2_bns_plus_nsbh_alpha_{alpha}_fj{fj_bns:.1f}'
    ...
    for alpha in alphas:
        ...
        for fj_bns in fj_bns_values:
            backend_path_stage2 = src.init.create_run_dir(
                f'universal_stage2_bns_plus_nsbh_alpha_{alpha}_fj{fj_bns:.1f}', 
        ...
        plt.savefig(f'contour_plots_fj_comparison_universal_alpha_{alpha}.pdf', dpi=150, bbox_inches='tight')
        plt.show()
    ...
    for i, alpha_diag in enumerate(alphas):
        ...
        for j, fj_bns_diag in enumerate(fjs):
            ...
            backend_path = src.init.create_run_dir(
                f'universal_stage2_bns_plus_nsbh_alpha_{alpha_diag}_fj{fj_bns_diag:.1f}', 
                output_files_default='Output_files'
            ) / 'emcee.h5'
            ...
            # Fixed Top-Hat Geometry: fraction > threshold is simply 1 if theta_c > threshold, else 0.
            ...
            above_bns = total_bns_yr_samp * (theta_bns_2 > theta_threshold)
            above_nsbh = total_nsbh_yr_samp * (theta_nsbh_2 > theta_threshold)
            ...
            for ax in (ax1, ax2):
                ...
                if n_rows > 1 or n_cols > 1:
                    ...
                    ax.set_xlabel(r'$\theta_c^{\mathrm{BNS}}$ (deg, universal)')
                    ax.set_ylabel(r'$\theta_c^{\mathrm{NSBH}}$ (deg, universal)')
